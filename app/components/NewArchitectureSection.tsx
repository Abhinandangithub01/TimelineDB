...
export function NewArchitectureSection() {
  return (
    <section id="architecture" className="py-20 px-6 bg-[#f8f9fa]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div className="bg-white rounded-xl p-6 border-2 border-gray-200 text-center">
            ...
            <div className="text-sm text-gray-600 font-medium">Complete Analysis</div>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-gray-200 text-center">
            ...
            <div className="text-sm text-gray-600 font-medium">RAG Accuracy</div>
        ...
        <div className="bg-white rounded-2xl border-2 border-gray-200 p-8 md:p-12">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900">Phase 1: RAG Strategy Testing</h3>
                <p className="text-gray-600">2 seconds • 4 forks in parallel</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-4 ml-4 md:ml-12">
              <div className="bg-gray-50 border-2 border-gray-200 rounded-lg p-4 text-center">
                ...
                <div className="font-bold text-gray-900 text-sm mb-1">Vector</div>
                <div className="text-xs text-gray-600">68% accuracy</div>
              </div>
              ...
              <div className="bg-gray-50 border-2 border-gray-200 rounded-lg p-4 text-center">
                ...
                <div className="font-bold text-gray-900 text-sm mb-1">BM25</div>
                <div className="text-xs text-gray-600">73% accuracy</div>
              </div>
              ...
              <div className="bg-gray-50 border-2 border-gray-200 rounded-lg p-4 text-center">
                ...
                <div className="font-bold text-gray-900 text-sm mb-1">Rerank</div>
                <div className="text-xs text-gray-600">85% accuracy</div>
              </div>
            </div>

            <div className="ml-4 md:ml-12 mt-4 text-sm text-gray-600">
              <span className="font-semibold text-gray-900">Result:</span> Hybrid selected as optimal strategy
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900">Phase 2: Domain Analysis</h3>
                <p className="text-gray-600">5 seconds • 4 domains using Hybrid search</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-4 ml-4 md:ml-12">
              <div className="bg-[#4285f4]/10 border-2 border-[#4285f4] rounded-lg p-4">
                ...
                <div className="font-bold text-gray-900 text-sm mb-1">Security</div>
                <div className="text-xs text-gray-600">12 issues found</div>
              </div>
              ...
              <div className="bg-[#4285f4]/10 border-2 border-[#4285f4] rounded-lg p-4">
                ...
                <div className="font-bold text-gray-900 text-sm mb-1">SOC2</div>
                <div className="text-xs text-gray-600">60% compliant</div>
              </div>
              ...
              <div className="bg-[#4285f4]/10 border-2 border-[#4285f4] rounded-lg p-4">
                ...
                <div className="font-bold text-gray-900 text-sm mb-1">ISO 27001</div>
              ...
              <div className="bg-[#4285f4]/10 border-2 border-[#4285f4] rounded-lg p-4">
                ...
                <div className="font-bold text-gray-900 text-sm mb-1">Performance</div>
                <div className="text-xs text-gray-600">78/100 score</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 bg-[#4CAF50]/10 border-2 border-[#4CAF50] rounded-lg p-6 flex items-center justify-center gap-3">
            ...
            <div>
              <div className="text-lg font-bold text-gray-900">Complete in 7 seconds!</div>
              <div className="text-sm text-gray-600">8.5x faster • Autonomous optimization • 89% accuracy</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600 mb-4">All 5 Tiger features in action:</p>
          <div className="flex flex-wrap justify-center gap-3">
            <span className="px-4 py-2 bg-white border-2 border-gray-200 rounded-full text-sm font-medium text-gray-700">
              Zero-Copy Forks
            </span>
            <span className="px-4 py-2 bg-white border-2 border-gray-200 rounded-full text-sm font-medium text-gray-700">
              Hybrid Search
