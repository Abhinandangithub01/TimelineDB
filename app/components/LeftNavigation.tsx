...
import { TimelineDBLogo } from './icons/TimelineDBLogo';
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-200 flex flex-col z-40">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <button className="w-full flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                ...
                <span className="font-medium">Fork Timeline</span>
              </button>
            </li>
          </ul>
        </div>
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="bg-gradient-to-br from-[#6366F1]/10 to-[#8B5CF6]/10 rounded-lg p-4">
